  ...
  FutureOr _showPermissionDialogue() {
    showDialog(
        ...
        builder: (context) => AlertDialog(
              ...
              content: const Text(
                  "The ClearAssist Audio recording features require access to your device's microphone. Please allow Microphone access in your device settings."),
              actions: <Widget>[
                TextButton(
        ...
        children: [
          ...
          Padding(
            padding: const EdgeInsets.only(
                top: 0.0), // Add padding for the status bar
            child: Row(
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  ElevatedButton(
                                    ...
                                    child:
                                        const Icon(Icons.delete), // Delete icon
                                  ),
                                ],
                              ),
